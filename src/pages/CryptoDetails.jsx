...
import { useGetCryptoDetailQuery, useGetCryptoHistroyQuery } from "../services/cryptoApi";
...
function CryptoDetails() {
    ...
    const { data, isLoading } = useGetCryptoDetailQuery(coinId);
                ...
                <Col className="coin-desc-link">
                    ...
                    <Col className="coin-links">
                        <Title level={3} className="coin-details-heading">
                            ...
                            {
                                cryptoDetails?.links.length > 0 && cryptoDetails.links.map((link, i) => (
